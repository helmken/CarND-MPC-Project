...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars)
    {
        ...
        // any anything you think that may be beneficial
        for (int i(0); i < N; ++i)
        {
        ...
        for (int i(0); i < N - 1; ++i)
        {
            ...
            fg[epsi_start + i + 2] = ((psi0 - psides0) - v0 * delta0 / Lf * dt);
        }
    }
};
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) 
{
    ...
    {
        // TODO: in the Q&A delta and a limits are swapped
